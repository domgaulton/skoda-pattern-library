$(document).ready(function () {
	...
	if($('.humanise-sidebar-ctas').length){
		...
		$('.humanise-sidebar-ctas').mouseenter(function(){
			$('.humanise-sidebar-ctas__links').addClass('active');
		});

		$('.humanise-sidebar-ctas__icons').click(function(){
			$('.humanise-sidebar-ctas__links').toggleClass('active');
		});

		$(window).scroll(function(){
			$('.humanise-sidebar-ctas__links').removeClass('active');
		});
